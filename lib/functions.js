...
exports.hex_to_date = function (data) {
...
hex_to_bin = function (hex_char) {
  return exports.str_pad(parseInt(hex_char, 16).toString(2),hex_char.length*4,'0');
};

exports.course_status = function (data){
  console.log('hex to bin before call');
  var bin = hex_to_bin(data);
  console.log('hex to bin after call' + bin);
